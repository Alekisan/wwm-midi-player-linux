...
const SPECIFIC_FONTS: &[(Instrument, &str, i32, i32)] = &[
    ...
    // Redistribution-friendly substitutes for the non-redistributable
    // ACCURATE_SF2 (Konghou 32/46 Harp, Fangxiang 32/98 VibeBell):
    (Instrument::Konghou, "concertharp", 0, 0), // FreePats Concert Harp (CC0)
    (Instrument::Fangxiang, "xylophone", 0, 0), // FreePats Xylophone (CC0)
];
